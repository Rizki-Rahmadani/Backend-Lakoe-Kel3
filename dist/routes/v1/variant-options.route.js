...
const variant = __importStar(require("../../controllers/variant-options.controller"));
const variantOptionRoutes = express_1.default.Router();
...
exports.default = variantOptionRoutes;
